...
//  */
//
// let helloMessage = sayHello("Savanna");
...
// let userTip = prompt("How much would you like to tip? Type in as a decimal percentage (:")
//
// console.log(calculateTip(userTotal, userTip))
//
// alert("You should tip " + "$ " + calculateTip(userTotal, userTip) );
